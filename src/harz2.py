...
def train(model,dataset_dirX='/notebooks/tmp/data/new_mrcnn_data/x',
 			dataset_dirY='/notebooks/tmp/data/new_mrcnn_data/ys/masks',
            config=None,
 			val_dataset_dirX='/notebooks/tmp/data/new_mrcnn_data/validation/x', 
 			val_dataset_dirY='/notebooks/tmp/data/new_mrcnn_data/validation/ys/masks', 
 			height=1024, width=1024, classnames = ['way', 'waterway','bomb','meiler','lake']):
    """Train the model."""
    # Training dataset.
